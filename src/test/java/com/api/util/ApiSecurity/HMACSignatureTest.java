...
public class HMACSignatureTest {
    ...
    public void L1_BaseString_Encoding_Test() {
        ...
        dataList.add(new String[]
                {
                        "GET&https://loadtest-pvt.api.lab/api/v1/rest/level1/in-in/&apex_l1_ig_app_id=loadtest-pvt" +
								"-4Swyn7qwKeO32EXdH1dKTeIQ&apex_l1_ig_nonce=-4985265956715077053" +
								"&apex_l1_ig_signature_method=HMACSHA256&apex_l1_ig_timestamp=1502159855341" +
								"&apex_l1_ig_version=1.0&param1=def+123",
